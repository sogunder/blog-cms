        ...
        <div className="p-6 border-t bg-gray-50/50">
          <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm mb-4">
             ...
             <button
              ...
              className="flex items-center justify-center space-x-2 w-full px-3 py-2 text-xs font-bold text-red-600 bg-red-50 hover:bg-red-100 rounded-lg transition-colors"
            >
              <LogOut size={14} />
              <span>Sign Out</span>
            </button>
          ...
          <div className="flex items-center flex-1 max-w-xl">
            <div className="relative w-full">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-gray-100/50 border-transparent focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 rounded-xl text-sm transition-all outline-none"
              />
            </div>
          </div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-4">
              <div className="text-right hidden sm:block">
                ...
                <Link to="/" className="text-[10px] font-bold text-indigo-600 hover:text-indigo-700 uppercase tracking-wider">
                  View Site
                </Link>
              </div>
              <div className="h-10 w-10 rounded-xl bg-gradient-to-tr from-indigo-600 to-violet-600 p-0.5">
                <div className="h-full w-full rounded-[9px] bg-white flex items-center justify-center text-indigo-600">
                  <UserIcon size={20} />
                </div>
              </div>
            </div>
